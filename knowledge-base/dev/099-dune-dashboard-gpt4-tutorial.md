...
>
> **日期**: Sun Mar 26 04:28:47 +0000 2023
>
> **標籤**: `Dune分析` `GPT-4助手` `數據可視化`

---

> **來源**: [@gm365 (gm365)](https://twitter.com/gm365)  
> **標籤**: `dune` `gpt-4` `數據分析` `零基礎` `教學`

---

## 新手福音！零基礎、對話方式製作 Dune 數據看板

Dune 之難，難於寫第一行 SQL 查詢語句。

好消息是，時代變了。現在有 GPT-4 加持，新手通過自然語言對話方式，也能飛速完成自己的第一個數據看板。

本教學以 zkSync Era 為例，帶大家體驗酣暢淋漓的 Dune 之旅。

範例看板：[zkSync Era Official Bridge Dashboard | Dune](https://t.co/9F0ckL5g0w)
